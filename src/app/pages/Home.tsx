...
export default function Home() {
  ...
  return (
    <div className="relative bg-black text-white min-h-screen font-['Barlow_Semi_Condensed',sans-serif] selection:bg-[#50C1BA] selection:text-black">
      ...
      <div className="relative z-10 w-full px-6 pt-24 md:pt-0 md:pl-[280px] md:pr-12 max-w-7xl mx-auto overflow-hidden">
        ...
        <section id="home" className="h-[calc(100vh-6rem)] md:h-screen flex flex-col items-center justify-between relative w-full pt-16 md:pt-32 pb-8 md:pb-12">
          ...
          <div className="flex-1 flex flex-col items-center justify-center text-center max-w-4xl w-full">
            <h1 className="text-[40px] md:text-[65.28px] leading-tight font-medium tracking-[5.22px] font-['Barlow_Semi_Condensed',sans-serif] uppercase text-white mb-8 md:mb-12">
              Multidisciplinary<br/>Designer
            </h1>
            <div className="font-['Rajdhani',sans-serif] font-semibold text-sm md:text-[21.66px] tracking-[5.41px] text-white uppercase leading-normal text-center whitespace-pre-wrap">
              <p className="mb-0">experience specialising in end-to-end design solutions</p>
      ...
      {/* Footer */}
      <footer id="contact" className="bg-[#1c1c1e] py-16 px-12 md:pl-[280px]">
