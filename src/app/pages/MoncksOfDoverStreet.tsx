...
import imgRectangle30 from "../../imports/MoncksOfDoverStreet-1/5193e76aa2da40140748e76b0bab1534ac9ccf8a.png";
import imgRectangle31 from "../../imports/MoncksOfDoverStreet-1/16c4df6c05c51ae80a80656941440025e24b26e5.png";
import imgRectangle32 from "../../imports/MoncksOfDoverStreet-1/f7409a73309c21ed7d6e1e140728ae516786fcd5.png";
import imgRectangle33 from "../../imports/MoncksOfDoverStreet-1/fbcaa43f2e019966b846322e007d00da2bafec69.png";
import imgRectangle4 from "../../imports/MoncksOfDoverStreet-1/d6dc0169d02bf250d8190d1fed447e89d8d5a544.png";
import imgRectangle23 from "../../imports/MoncksOfDoverStreet-1/4142daa82b830c04d4aac911aa1294fd073be33a.png";
...
import imgRectangle40 from "../../imports/MoncksOfDoverStreet-1/98ce850bbdf3b4c501620bc7925ccfcc977f9ae2.png";
    ...
    <div className="relative bg-black text-white min-h-screen font-['Barlow_Semi_Condensed',sans-serif] selection:bg-[#50C1BA] selection:text-black">
      ...
      <nav className="hidden md:flex fixed top-0 left-0 h-screen w-[280px] py-14 px-10 flex-col z-50 mix-blend-difference justify-between">
        ...
        <div className="flex flex-col gap-5 pl-4 relative">
          ...
          <a href="https://instagram.com" target="_blank" rel="noreferrer" className="text-white hover:text-[#50C1BA] transition-colors"><SocialInstagram className="w-[15px] h-[15px]" /></a>
          <a href="https://linkedin.com" target="_blank" rel="noreferrer" className="text-white hover:text-[#50C1BA] transition-colors"><SocialLinkedin className="w-[15px] h-[15px]" /></a>
      ...
      <div className="relative z-10 w-full md:pl-[280px]">
        ...
        <section className="border-b border-gray-800">
          <div className="max-w-7xl mx-auto px-6 md:px-12 py-12 flex flex-wrap gap-12 md:gap-24 uppercase font-['Barlow',sans-serif] font-medium tracking-[0.25em] text-sm md:text-[26px]">
            <div>
        ...
        <section className="max-w-7xl mx-auto px-6 md:px-12 py-24 md:py-32 grid grid-cols-1 lg:grid-cols-12 gap-16">
          <div className="lg:col-span-4 flex flex-col gap-16">
            <div>
              ...
              <div className="font-['Inter',sans-serif] font-light text-[15px] md:text-[16.8px] leading-[1.6] tracking-[0.05em] text-gray-300 space-y-4">
          ...
          <div className="lg:col-span-8 flex flex-col gap-12">
            ...
            <div className="font-['Inter',sans-serif] font-light text-[18px] md:text-[22.9px] leading-[1.6] tracking-[0.05em] text-gray-200">
        ...
        <section className="max-w-7xl mx-auto px-6 md:px-12 py-24 md:py-32">
          <div className="text-center mb-16">
            ...
            <div className="font-['Barlow',sans-serif] font-medium text-[12px] md:text-[14px] tracking-[0.25em] uppercase text-gray-400 max-w-2xl mx-auto text-left">
              ...
              <ul className="list-disc pl-6 space-y-2">
                <li>Prove craftsmanship</li>
                <li>Show process</li>
                <li>Demonstrate systems thinking</li>
              </ul>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            <div className="col-span-1 md:col-span-2 lg:col-span-3">
              <img src={imgRectangle23} alt="Breakdown Main" className="w-full h-auto object-cover rounded-lg" />
            </div>
            <div className="col-span-1">
              <img src={imgRectangle30} alt="Breakdown UI 1" className="w-full h-auto object-cover rounded-3xl" />
            </div>
            <div className="col-span-1">
              <img src={imgRectangle32} alt="Breakdown UI 2" className="w-full h-auto object-cover rounded-3xl" />
            </div>
            <div className="col-span-1">
              <img src={imgRectangle33} alt="Breakdown UI 3" className="w-full h-auto object-cover rounded-3xl" />
            </div>
            <div className="col-span-1 md:col-span-2 lg:col-span-3">
              <img src={imgRectangle40} alt="Breakdown Large" className="w-full h-auto object-cover rounded-lg" />
            </div>
          </div>
        </section>
        ...
        <section className="border-t border-gray-800">
          <div className="max-w-7xl mx-auto px-6 md:px-12 py-24 md:py-32 grid grid-cols-1 lg:grid-cols-12 gap-16">
            <div className="lg:col-span-4">
              <h2 className="font-['Inter',sans-serif] font-light text-[24px] md:text-[31px] tracking-[0.05em] text-[#50C1BA] mb-6">Responsibilities</h2>
            </div>
            <div className="lg:col-span-8 font-['Inter',sans-serif] font-light text-[16px] md:text-[22px] leading-[1.6] tracking-[0.05em] text-gray-300 space-y-8">
